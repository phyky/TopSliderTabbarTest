...
-(NSMutableArray *)taBarItemEntities{
    ...
    item0.controllerName=@"CSScroTabbarTestViewController";
    ...
    item1.controllerName=@"CSScroTabbarTestViewController";
...
- (UIView *)controllerView{
    if (_controllerView == nil) {
        _controllerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width,self.view.frame.size.height-BOTTOM_BAR_HEIGHT)];
