...
- (void)viewDidLoad {
    ...
    [self.tableView addObserver:self.parentViewController forKeyPath:OBSERVER_KEYPATH options:NSKeyValueObservingOptionNew | NSKeyValueObservingOptionOld context:nil];
}

-(void)dealloc {
    [self.tableView removeObserver:self.parentViewController forKeyPath:OBSERVER_KEYPATH context:nil];
}
